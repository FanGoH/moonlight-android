...
JNIEXPORT void JNICALL
Java_com_limelight_nvstream_jni_MoonBridge_sendMousePositionOnDisplay(JNIEnv *env, jclass clazz,
        jshort x, jshort y, jshort referenceWidth, jshort referenceHeight, jshort displayIndex) {
    LiSendMousePositionEventOnDisplay(x, y, referenceWidth, referenceHeight, (unsigned short)displayIndex);
}
